...
class KBAnalysisValidator {
  ...
  bool _isValidQuestion(Question q) => _notEmpty(q.author) && _notEmpty(q.date) && _notEmpty(q.area);
  bool _isValidAnswer(Answer a) => _notEmpty(a.author) && _notEmpty(a.date) && _notEmpty(a.area);
  bool _isValidNote(Note n) => _notEmpty(n.author) && _notEmpty(n.date) && _notEmpty(n.area);
