...
class LiteRtLmEngineOptions {
  external factory LiteRtLmEngineOptions({
    ...
    /// Optional executor settings. On web this is the only place where the
    /// context-window size (`maxNumTokens`) can be configured; without it the
    /// engine falls back to the model's baked default (often 4096 tokens).
    JSObject? mainExecutorSettings,
  });
}
